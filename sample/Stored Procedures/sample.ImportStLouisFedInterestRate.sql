...
CREATE PROCEDURE sample.ImportStLouisFedInterestRate
(
...
BEGIN
   ...
   BEGIN
      ...
      SELECT @LastActionWhen, @LastActionById,Id+@StartId,1,@InstrumentId,@Source,convert(datetime,[Date]),convert(decimal(28,8),[Value]),@Ccy
      FROM #staging
   END
